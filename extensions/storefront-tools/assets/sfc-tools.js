...
(() => {
  ...
  // extensions/storefront-tools/src/countries.js
  var COUNTRIES = [
  ...
  function populateCountrySelect(select) {
    if (!select || select.dataset.countryPopulated === "true") return;
    select.dataset.countryPopulated = "true";
    const placeholder = select.querySelector('option[value=""]') || (() => {
      const blank = document.createElement("option");
      blank.value = "";
      blank.textContent = "Select destination";
      blank.disabled = true;
      blank.selected = true;
      blank.hidden = true;
      return blank;
  ...
  function initSfcTools(root) {
    ...
    root.querySelectorAll("select[data-country-options]").forEach(populateCountrySelect);
